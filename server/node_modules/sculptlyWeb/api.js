...
///
function CommandRequest( name ){
    // Call parent constructor and set up privates
    m.stream.Stream.call(this);
    var self = this;

    // Set up additional stream variables
    this.readable = true;
    this._cmdName = name;
}
...
/// @protected
///
/// Helper method for emitting an error through the CommandRequest stream.
///
